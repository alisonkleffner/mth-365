...
- Due Thursday March 5th at 11:59 pm in Blueline
...
---
### Looking for Potential Correlation

__Example__: Review NYC flight data. What variables, if any, are related to flight arrival delays? Consider a random sample of 1000 flights from NYC to Chicago in 2013.
...
**Focus**: if the time of the flights (`hour`) is related to arrival delay (`arr_delay`)?
...
- A common concern with observational data is that correlations are distorted by other variables 
<br>
<br>
