...
## ----fig.height=4.5, fig.width=8, fig.align='center', fig.alt="Density plot depicting the approximate sampling distribution of the sample mean. It is an approximate bell-shaped curve."----
...
## ----message=FALSE, warning=FALSE, fig.align='center', fig.height=4, fig.width=8, echo=FALSE, fig.alt="This figure shows the impact of sample size on sampling distributions. As the sample size increases from 50 to 500, the width or variability of the sampling distribution becomes narrower."----
...
## ----fig.height=4.5, fig.width=8, fig.align='center', fig.alt="Density plot of the bootstraped distribution for sample means. This is approximately normal and is similar in appearance to the sampling distribution."----
...
## ----echo = FALSE, fig.align='center', fig.width=10, fig.height=5, fig.alt="Histogram of a simulated null distribution that looks approximately normal."----
