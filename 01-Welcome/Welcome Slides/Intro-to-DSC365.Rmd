...
.center[
```{r, echo=FALSE, out.width="60%", fig.alt = "Venn Diagram depicting skills that a good data scientist must have. Data scientists needs skills from math and stats, computer science, and domain area."}
...
```{r, echo=FALSE, fig.align='center', out.width="60%", fig.alt = "Visual of the R Console. This is the place where you would type R code."}
