...
```{r, echo=FALSE, out.width="100%", fig.align='center', fig.alt= "Zoomed in view of the Editor window, where the user can write and save code. Highlighted in the top right of the picture is the Run button, which runs the line of code your cursor is placed on."}
