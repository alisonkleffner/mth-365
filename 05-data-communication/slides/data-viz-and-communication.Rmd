...
i1 <- img_modal(src = "../slides/images/bad-pie.PNG", alt = "Pie chart of how people voted for president in 2016.", other=list(width="90%"))
i3 <- img_modal(src = "../slides/images/bad-color.png", alt = "Map of suicide rates by country with a bad color scheme.", other=list(width="85%"))
...
i2 <- img_modal(src = "../slides/images/bad-line.PNG", alt = "Line chart of Asian Hate Crime reports over time.", other=list(width="100%"))
i4 <- img_modal(src = "../slides/images/bad-bar.png", alt = "Bar Chart of Number of Covid-19 cases by country over time.", other=list(width="100%"))
...
The caption only shows in the rendered version of documents. Why we need a descriptive caption? 
