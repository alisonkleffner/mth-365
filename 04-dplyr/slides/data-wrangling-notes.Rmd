...
- Quiz #1
  + Last 30 Minutes on Thursday February 7
...
#### Option 2
```{r, echo=FALSE, out.width="80%", fig.alt="Example 1 of a dataset in spreadsheet format. Have four columns for patient and each of the three names of the patients. The rows are for each treatment."}
...
#### Option 3
```{r, echo=FALSE, out.width="80%", fig.alt="Example 1 of a dataset in spreadsheet format. Have three columns for patient, treatment, and score. Has six rows, one for each person and treatment combination."}
